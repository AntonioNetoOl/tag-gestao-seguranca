...
export class FuncionariosPageComponent implements OnInit {
  ...
  salvarFuncao(): void {
    if (this.funcaoForm.invalid) { this.funcaoForm.markAllAsTouched(); this.abrirErro('Informe a função', 'O nome da função é obrigatório.'); return; }
  ...
  fecharModal(): void { if (this.salvando) return; this.modalAberto = false; this.funcionarioSelecionado = null; this.form.reset(); }
